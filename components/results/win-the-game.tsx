    ...
    <div className="flex flex-col items-center justify-center gap-10">
      <div className="flex flex-col items-center gap-4">
        ...
        <p className="text-lg text-neutral-500">
          You won the game. You can now play again or play Endless Mode (Premium
          Required).
        </p>
      </div>
      ...
      <div className="flex gap-4">
        ...
        <div className="bg-[#efcb68] rounded-2xl flex flex-col justify-between p-4 aspect-square w-60">
          <h1 className="text-2xl font-semibold">Play endless</h1>
          <p className="text-neutral-700">
            Play the game in endless mode and keep scoring higher and higher.
          </p>
        </div>
      </div>
    </div>
