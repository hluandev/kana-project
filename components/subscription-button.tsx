...
export function SubscriptionButton() {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="bg-[#efcb68] border border-black/10  shadow-sm hover:bg-yellow-600/40 py-1.5 w-full flex items-center justify-center text-center font-medium rounded-lg"
    >
