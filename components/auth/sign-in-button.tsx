...
export const SignInButton = ({ brand, signInWith, icon, onClick }: Props) => {
  ...
  return (
    <button
      className="bg-white hover:bg-neutral-100 duration-200 flex justify-center items-center w-64 text-[0.9rem] rounded-md h-11 border border-black/10 shadow-sm"
