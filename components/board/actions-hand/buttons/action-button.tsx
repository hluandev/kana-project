...
export const ActionButton = ({
  ...
  return (
    <div
      ...
      className={`flex relative items-center text-black justify-center gap-2 w-7 h-7 lg:w-9 lg:h-9 aspect-square text-center rounded-full duration-200 cursor-pointer ${className}`}
      onClick={handleClick}
    >
      <AnimatePresence>
