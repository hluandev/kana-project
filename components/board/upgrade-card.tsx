    ...
    <motion.div
      ...
      className={`${
        isActive
          ...
          : "border-white"
      } relative text-xs lg: w-28 border-2 bg-black/5 lg:w-36 shadow-sm lg:p-2 p-1 rounded-lg`}
    >
      <div>
        <div className="flex justify-between items-center">
          ...
          {count > 1 && (
            <span className=" absolute right-2 lg:top-2 max-lg:top-1/2 max-lg:-translate-y-1/2 bg-black/5 px-1 py-0.5 border border-black/10 shadow-sm rounded-md">
              x{count}
            </span>
          )}
        </div>
