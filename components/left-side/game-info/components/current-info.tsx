...
export const CurrentInfo = () => {
  ...
  return (
    <Box className="p-0 grid grid-cols-2 grid-rows-2 overflow-hidden">
      {/* Discard */}
      <div className="border-b text-center bg-red-600/5 text-red-400 border-r border-neutral-300 py-8">
        {discard}
      </div>

      {/* Turns */}
      <div className="border-b text-center bg-blue-600/5 text-blue-400 border-neutral-300 py-8">
        {turns}
      </div>

      {/* Matches */}
      <div className="border-r text-center border-neutral-300 py-8">
