...
import { ActivityIcon, BookIcon, InboxIcon, SwordsIcon, TrophyIcon, UserIcon, XIcon } from "lucide-react";
    ...
    <>
      ...
      <div className="max-lg:hidden flex flex-col gap-6 pt-2">
        ...
        <div className="flex flex-col gap-1">
          ...
          <LinkNav icon={<SwordsIcon className="w-[1.1rem] h-[1.1rem]" />} href="/menu/play">Play</LinkNav>
          <LinkNav icon={<BookIcon className="w-[1.1rem] h-[1.1rem]" />} href="/menu/docs">How to play</LinkNav>
          <LinkNav icon={<TrophyIcon className="w-[1.1rem] h-[1.1rem]" />} href="/menu/leaderboard">Leaderboard</LinkNav>
          <LinkNav icon={<ActivityIcon className="w-[1.1rem] h-[1.1rem]" />} href="/menu/activity">Activity</LinkNav>
        </div>
        <div className="flex flex-col gap-1">
          
          <p className="px-2.5 font-semibold text-neutral-500">Communication</p>
          <LinkNav icon={<InboxIcon className="w-[1.1rem] h-[1.1rem]" />} onClick={handleInboxClick} href="/menu/inbox">
            Inbox ({unreadCount})
          </LinkNav>
          <LinkNav icon={<UserIcon className="w-[1.1rem] h-[1.1rem]" />} blank href="https://x.com/ru_an_ng">
            Social
          </LinkNav>
        </div>
      </div>
