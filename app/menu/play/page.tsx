      ...
      <div className="flex gap-8 ">
        {PlayMode.map((item, index) => (
          <Link
            ...
            prefetch
            key={index}
            className="bg-pink-400/70 relative text-center rounded-md border border-pink-500 flex-col px-10 gap-3  backdrop-blur-md h-[30rem] w-72 flex justify-center items-center text-4xl"
          >
