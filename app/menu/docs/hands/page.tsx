  ...
  return (
    <Doc mxAuto title="3. Hands">
      ...
      <div className="space-y-2 flex flex-col items-center">
        <div className="flex flex-col justify-between items-center w-40 h-56 p-2 bg-white border border-black/15 shadow-sm rounded-lg">
      ...
      <div className="space-y-2">
        ...
        <div className="flex gap-2 justify-center">
          <p className="bg-[#ff915a] h-8 w-8 border border-black/15 shadow-sm flex justify-center items-center  rounded-lg aspect-square">
            あ
          </p>
          <p className="bg-[#01de5b] h-8 w-8 border border-black/15 shadow-sm flex justify-center items-center  rounded-lg aspect-square">
            う
          </p>
          <p className="bg-[#e4e4e6] h-8 w-8 border border-black/15 shadow-sm flex justify-center items-center  rounded-lg aspect-square">
            お
          </p>
          <p className="bg-[#ffe65e] h-8 w-8 border border-black/15 shadow-sm flex justify-center items-center  rounded-lg aspect-square">
            い
          </p>
          <p className="bg-[#fc96df] h-8 w-8 border border-black/15 shadow-sm flex justify-center items-center  rounded-lg aspect-square">
            え
          </p>
        </div>
      </div>
